...
{#if player}
    ...
    >
        ...
        >
            <div
                class="w-9 h-9 rounded-full bg-[color-mix(in_srgb,var(--primary-color)_20%,transparent)] border border-[color-mix(in_srgb,var(--primary-color)_40%,transparent)] flex items-center justify-center text-xs font-black text-[var(--primary-color)] shrink-0"
            >
