...
<Layout>
    <div class="max-w-2xl mx-auto pb-28">
        <div class="mb-8 text-center">
            <h1
                class="text-3xl font-black tracking-wide text-[var(--text-color)] mb-1"
            >
                🏆 Leaderboard
            </h1>
            <p
                class="text-sm text-[color-mix(in_srgb,var(--text-color)_40%,transparent)] font-mono uppercase tracking-widest"
            >
                Top 50 cadets
            </p>
        </div>
