...
<Layout>
    <div class="max-w-4xl mx-auto pb-16 px-4">
        ...
        >
            <div>
                <h1
                    class="text-2xl sm:text-3xl font-black tracking-wide text-[var(--text-color)]"
                >
                    🛍️ Store
                </h1>
                <p
                    class="text-sm text-[color-mix(in_srgb,var(--text-color)_40%,transparent)] font-mono uppercase tracking-widest mt-1"
                >
                    Spend your coins
                </p>
            </div>
